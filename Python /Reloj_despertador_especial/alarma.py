...
def introducir_alarma()-> object:
    '''Input de alarma del usuario'''
...
def calcular_tiempo_espera(alarma_usuario:object)-> object:
...
def esperar_tiempo(tiempo_espera:object):
...
alarma_usuario = introducir_alarma()
tiempo_espera = calcular_tiempo_espera(alarma_usuario)
esperar_tiempo(tiempo_espera)
reproducir_alarma()